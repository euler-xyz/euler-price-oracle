...
contract SwaapOracle is BaseAdapter {
    /// @inheritdoc IPriceOracle
    string public constant name = "SwaapOracle";
    /// @notice The address of the Swaap Pool Token (LP).
    ...
    function _getQuote(uint256 inAmount, address _base, address _quote) internal view override returns (uint256) {
        ...
        uint256 rate = ISwaap(rateProvider).getRate();
