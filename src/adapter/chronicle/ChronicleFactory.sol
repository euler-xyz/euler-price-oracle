...
/// @title ChronicleFactory
/// @author Euler Labs (https://www.eulerlabs.com/)
/// @notice Chronicle oracle factory with a feed registry.
contract ChronicleFactory is BaseAdapterFactory {
        ...
        returns (address)
    {
        ...
        return address(new ChronicleOracle(base, quote, feed, maxStaleness));
    }
}
