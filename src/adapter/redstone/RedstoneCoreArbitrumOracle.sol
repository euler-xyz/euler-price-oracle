...
import {ArbitrumProdDataServiceConsumerBase} from
    "@redstone/evm-connector/data-services/ArbitrumProdDataServiceConsumerBase.sol";
...
/// @title RedstoneCoreArbitrumOracle
/// @custom:security-contact security@euler.xyz
/// @author Euler Labs (https://www.eulerlabs.com/)
/// @notice Adapter for Redstone pull-based price feeds on Arbitrum.
contract RedstoneCoreArbitrumOracle is ArbitrumProdDataServiceConsumerBase, BaseAdapter {
    ...
    string public constant name = "RedstoneCoreArbitrumOracle";
    ...
    /// @notice Deploy a RedstoneCoreArbitrumOracle.
