...
contract ScaleUtilsHarness {
    ...
    function calcScale(uint8 baseDecimals, uint8 quoteDecimals, int8 priceDecimals) external pure returns (Scale) {
        return ScaleUtils.calcScale(baseDecimals, quoteDecimals, priceDecimals);
    }
