...
contract PendleUniversalOracleHelper is AdapterHelper {
    ...
    function setUpState(FuzzableState memory s) internal {
        ...
        oracle = address(new PendleUniversalOracle(s.pendleOracle, s.pendleMarket, s.base, s.quote, s.twapWindow));
